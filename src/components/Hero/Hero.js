    ...
    >
      <div className={`${styles.section} w-[90%] 800px:w-[60%]`}>
        ...
        <p className="pt-5 text-[16px] font-[Poppins] font-[400] text-[#000000ba]">
          ...
          <br /> exercitationem labore vel, dolore quidem asperiores, laudantium temporibus soluta optio
          consequatur <br /> aliquam deserunt officia. Dolorum saepe nulla provident.
        </p>
